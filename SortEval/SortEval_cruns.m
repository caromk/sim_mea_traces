function [E,comps,varargout] = SortEval_cruns(T,varargin)
...
tic
[E.spike_trains,spike_comps,comps,E.n_dups,E.best_spike_index,E.ind_spiking_comps,E.separation,E.peak_variation,wts,E.dup,E.best_spike_index,E.putative_spike_index] = RobustSpikeSort(T.traces(:,1:alt_length),T.sampling_rate,'Verbose',verbose,'MaxPeakVariation',max_peak_variation,'MinSeparation',min_separation,'Comps',comps,'AllThresSpikes',all_thres_spikes,'IndSpaceSplits',ind_space_splits,'UseBinary',use_binary,'MinNSpike',min_n_spike);
E.run_time = toc;

function [E comps varargout] = SortEval2(T,varargin)

default_alt_length = size(T.traces,2);
default_comps = [];
default_verbose = 0;
default_max_peak_variation = 0.2;
default_min_separation = 0.2;
...
tic
[E.spike_trains,spike_comps,comps,E.n_dups,E.best_spike_index,E.ind_spiking_comps,E.separation,E.peak_variation] = RobustSpikeSort2(T.traces(:,1:alt_length),T.sampling_rate,'Verbose',verbose,'MaxPeakVariation',max_peak_variation,'MinSeparation',min_separation,'Comps',comps);
E.run_time = toc;
